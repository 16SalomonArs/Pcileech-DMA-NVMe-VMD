...
module pcileech_pcie_a7x4(
    ...
    pcileech_pcie_tlp_a7 i_pcileech_pcie_tlp_a7(
        ...
        .pcie_id                    ( pcie_id                   ),   // <- [15:0]
        .msix_enable                ( ctx.cfg_interrupt_msixenable ),
        .msix_function_mask         ( ctx.cfg_interrupt_msixfm   ),
        .nvme_ctrl_reset            ( ctx.cfg_received_func_lvl_rst || (ctx.cfg_pmcsr_powerstate == 2'b11) ),
        .nvme_irq_req               ( nvme_irq_req              ),
        .base_address_register      ( base_address_register     )
    );
