# Generate the ZDMA 100T x4 NVMe disk firmware project.
...
set sv_files [list \
    ...
    "$origin_dir/src/pcileech_com_e.v" \
    "$origin_dir/src/pcileech_fifo.sv" \
    "$origin_dir/src/pcileech_mux.sv" \
    "$origin_dir/src/pcileech_pcie_a7x4.sv" \
    ...
    "$origin_dir/src/pcileech_tbx4_100t_top.sv" \
]
